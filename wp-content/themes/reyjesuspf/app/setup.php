...
require_once get_template_directory() . '/app/enqueue/enqueue.php';
require_once get_template_directory() . '/app/form/contactos.php';
require_once get_template_directory() . '/app/form/eventos.php';
require_once get_template_directory() . '/app/form/registros.php';
