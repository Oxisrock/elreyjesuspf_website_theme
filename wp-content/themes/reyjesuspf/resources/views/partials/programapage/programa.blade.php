                    ...
                    <div class="-my-8 divide-y divide-gray-300">
                        ...
                        <div class="py-8">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-xs font-medium text-blue-500">45 minutos</span>
                            </div>
                            <h3 class="mt-3 text-lg font-semibold text-gray-900 sm:text-lg">
                                Alabanzas con María Gómez
                            </h3>
                        ...
                        <div class="py-8">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-xs font-medium text-blue-500">60 minutos</span>
                            </div>
                            <h3 class="mt-3 text-lg font-semibold text-gray-900 sm:text-lg">
                                Adoración con Domenico Méndez
                            </h3>
                            <p class="mt-2 text-sm text-gray-600">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros
                                elementum tristique.
                        ...
                        <div class="py-8">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-xs font-medium text-blue-500">30 minutos</span>
                            </div>
                            <h3 class="mt-3 text-lg font-semibold text-gray-900 sm:text-lg">
                                Canto con Laura Aular
                            </h3>
                            <p class="mt-2 text-sm text-gray-600">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros
                                elementum tristique.
