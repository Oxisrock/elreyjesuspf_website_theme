    ...
    <div class="container mx-auto max-w-7xl p-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
            ...
            <div
                ...
                <img class="aspect-video w-full object-cover" src="@asset('images/events-page/Domingo de la vision .webp')" alt="Evento Pijamada de Mujeres">
                <div class="p-6">
            ...
            <div
                class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <img class="aspect-video w-full object-cover" src="@asset('images/events-page/Eliap 2025.jpg')" alt="Evento Revival">
                <div class="p-6">
                    <div class="flex justify-between items-center">
                        <span
            ...
            <div
                class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <img class="aspect-video w-full object-cover" src="@asset('images/events-page/Gran Cruzada .webp')"
        ...
        <div class="text-center mt-20">
            <a href="{{get_post_type_archive_link('events')}}"
