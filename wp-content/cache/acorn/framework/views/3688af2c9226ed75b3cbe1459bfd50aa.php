<div class="bg-gray-100">
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <div class="w-full md:w-2/5 bg-white flex flex-col justify-center p-8 sm:p-12">
            <div class="w-full max-w-sm mx-auto">
                ...
                <div class="flex items-center justify-center">
                    <img src="<?= \Roots\asset('images/header-page/Logoiglesiaazul.png'); ?>" alt="Logo de la iglesia" class="h-14 w-14 mb-6">
                </div>
        ...
        <div class="hidden md:flex w-3/5 relative bg-cover bg-center" style="background-image: url('<?= \Roots\asset('images/hero-page/Un camino de fe.13f7f6.jpg'); ?>');">
...
</div><?php /**PATH /var/www/html/wp-content/themes/reyjesuspf/resources/views/partials/formpage/form.blade.php ENDPATH**/ ?>