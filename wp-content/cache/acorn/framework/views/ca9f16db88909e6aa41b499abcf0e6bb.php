        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
            ...
            <div class="flex flex-col w-full">
                ...
                <div class="block md:hidden">
                    <img src="<?= \Roots\asset('images/nuestrahistoria-page/DSC_0548.jpg'); ?>" alt="Equipo de ReyCristo (Móvil)" 
                         class="rounded-xl mb-8 w-full h-full object-top object-cover">
                </div>

                <div class="hidden md:block">
                    <img src="<?= \Roots\asset('images/nuestrahistoria-page/DSC_0548.jpg'); ?>" alt="Equipo de ReyCristo (Escritorio)" 
...
</div><?php /**PATH /var/www/html/wp-content/themes/reyjesuspf/resources/views/partials/nuestrahistoriapage/nuestrahistoria.blade.php ENDPATH**/ ?>