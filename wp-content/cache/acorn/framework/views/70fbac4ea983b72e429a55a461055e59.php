    ...
    <div class="container mx-auto max-w-14xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-10 rounded-xl overflow-hidden">
            ...
            <div class="md:col-span-6 relative overflow-hidden md:order-last order-first">
                <img src="<?= \Roots\asset('images/events-page/maxresdefault (2).jpg'); ?>" alt="Grandes Hombres de Dios"
...
<?php /**PATH /var/www/html/wp-content/themes/reyjesuspf/resources/views/partials/summarypage/summary.blade.php ENDPATH**/ ?>