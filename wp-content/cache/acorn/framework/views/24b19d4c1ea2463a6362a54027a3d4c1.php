    ...
    <div class="relative max-w-6xl mx-auto my-12 p-8 sm:p-12">
        ...
        <div class="relative z-10 space-y-16">
            ...
            <div class="relative grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <img src="<?= \Roots\asset('images/vision-page/evangelizar .jpg'); ?>" alt="Evangelizar" class="rounded-3xl w-[450px] h-auto object-cover">
                </div>
            </div>
            ...
            <div class="relative grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="md:order-last">
                    <img src="<?= \Roots\asset('images/vision-page/Afirmar .webp'); ?>" alt="Afirmar" class="rounded-2xl w-full h-[450px] object-cover">
                </div>
            </div>
            ...
            <div class="relative grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <img src="<?= \Roots\asset('images/vision-page/Discipular.webp'); ?>" alt="Discipular" class="rounded-3xl w-[470px] h-auto object-cover">
                </div>
            </div>
            ...
            <div class="relative grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="md:order-last">
                    <img src="<?= \Roots\asset('images/vision-page/enviar.webp'); ?>" alt="Enviar" class="rounded-3xl mb-8 w-full h-[470px] object-top object-cover">
                </div>
            </div>

        </div>
    </div>
</div><?php /**PATH /var/www/html/wp-content/themes/reyjesuspf/resources/views/partials/visionpage/vision.blade.php ENDPATH**/ ?>