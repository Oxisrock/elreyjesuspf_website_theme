...
<div class="bg-gray-100">
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <div class="hidden md:flex w-full md:w-3/5 md:h-auto relative bg-cover bg-center"
             style="background-image: url('<?= \Roots\asset('images/hero-page/Un camino de fe.13f7f6.jpg'); ?>');">
...
</div><?php /**PATH /var/www/html/wp-content/themes/reyjesuspf/resources/views/partials/loginpage/login.blade.php ENDPATH**/ ?>